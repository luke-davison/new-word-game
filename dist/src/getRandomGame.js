...
exports.countLetters = exports.sortByFrequency = exports.getRandomWord = exports.generateGame = void 0;
const enums_1 = require("../client/src/shared/enums");
const utils_1 = require("../client/src/shared/utils");
const generateGame = () => {
    const letters = (0, exports.getRandomWord)().split('');
    const uniqueLetters = (0, exports.sortByFrequency)(Array.from(new Set(letters)));
    const output = [];
    const mostCommonLetter = uniqueLetters.splice(0, 1)[0];
    let mostCommonLetterOutput = {
    ...
    const abilitiesShuffled = [];
    for (let i = 0; i < letters.length - 1; i++) {
        abilitiesShuffled.push(abilities.splice(Math.floor(Math.random() * abilities.length), 1)[0]);
    }
    const abilityReshuffled = new Set();
    for (let letterIndex = letters.length - 1; letterIndex >= 0; letterIndex--) {
        const char = letters[letterIndex];
        if (char === (mostCommonLetterOutput === null || mostCommonLetterOutput === void 0 ? void 0 : mostCommonLetterOutput.char)) {
            output.unshift(Object.assign({}, mostCommonLetterOutput));
            ...
            if (ability === 'set-points') {
                ...
                if (letters[0] === char) {
                    ...
                    output.unshift({
                        ...
                        ability: enums_1.Abilities.InPosition1,
                        abilityPoints: 4
                    });
                }
            }
                ...
                switch (minLength) {
                    case 6:
                        ability = enums_1.Abilities.MinWordLength6;
                        break;
                    case 7:
                        ability = enums_1.Abilities.MinWordLength7;
                        break;
                }
                ...
                if ('hjklmnqrvxz'.includes(char)) {
                    ...
                    output.unshift({
                        ...
                        price: 4,
                        points: 3 + frequencyFactor,
                        ability: enums_1.Abilities.NextToVowel,
                        abilityPoints: (0, utils_1.getIsCharacterVowel)(char) ? 4 : 3
                    });
                }
            }
            else if (ability === 'multiply') {
                // TODO - more expensive if large letter exists
                const possiblePositions = [enums_1.Abilities.OtherInPosition1, enums_1.Abilities.OtherInPosition2, enums_1.Abilities.OtherInPosition3, enums_1.Abilities.OtherInPosition4];
                ...
                if ('dijqrsuvwxy'.includes(char)) {
                    ...
                    output.unshift({
                        ...
                        price: 3,
                        points: 4 + frequencyFactor,
                        ability: enums_1.Abilities.InPositionLast,
                        abilityPoints: 4
                    });
                }
            }
                ...
                output.unshift({
                    char,
                    price: 4,
                    points: (0, utils_1.getIsCharacterVowel)(char) ? 3 : 4,
                    ability: enums_1.Abilities.Vowels,
                    abilityPoints: 1
                });
            }
                ...
                output.unshift({
                    ...
                    price: 4,
                    points: 3,
                    ability: enums_1.Abilities.Wilds,
                    abilityPoints: 1
                });
            }
                ...
                output.unshift({
                    ...
                    price: 4,
                    points: 3 + frequencyFactor,
                    ability: enums_1.Abilities.NextToWild,
                    abilityPoints: 3
                });
            }
            else if (ability === 'other-position') {
                const positions = [enums_1.Abilities.InPosition2, enums_1.Abilities.InPosition3, enums_1.Abilities.InPosition4];
                ...
                if ('aehijklmnoqruvxz'.includes(char)) {
                    ...
                    output.unshift({
                        ...
                        points: 4,
                        ability: enums_1.Abilities.NotNextToVowel,
                        abilityPoints: 4
                    });
                }
            }
                ...
                const lengths = [enums_1.Abilities.WordLength5, enums_1.Abilities.WordLength6, enums_1.Abilities.WordLength7];
                ...
                const otherPositions = [enums_1.Abilities.CopyAbilityInPosition1, enums_1.Abilities.CopyAbilityInPosition2, enums_1.Abilities.CopyAbilityInPosition3, enums_1.Abilities.CopyAbilityInPosition4, enums_1.Abilities.CopyAbilityInPosition5];
...
const getRandomWord = () => {
    const r = Math.random();
    const wordlistLength = utils_1.wordlist.length;
    const index = Math.floor(r * wordlistLength);
    const word = utils_1.wordlist[index];
    if (word.length >= 6 && word.length <= 7) {
        return word;
    }
    return (0, exports.getRandomWord)();
};
exports.getRandomWord = getRandomWord;
const sortByFrequency = (letters) => {
...
(0, exports.generateGame)();
//# sourceMappingURL=getRandomGame.js.map