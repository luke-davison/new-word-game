...
exports.TutorialMessages = void 0;
require("./styles/TutorialMessages.css");
const mobx_react_lite_1 = require("mobx-react-lite");
const react_1 = require("react");
const Popup_1 = require("../../general/Popup");
exports.TutorialMessages = (0, mobx_react_lite_1.observer)(() => {
    const [messageIndex, setMessageIndex] = (0, react_1.useState)(1);
    let popupBody;
    let popupElementId;
    switch (messageIndex) {
        case 1:
    ...
    return (<Popup_1.Popup key={messageIndex} className="tutorial-message" onClose={handleClose} elementId={popupElementId}>
      {popupBody}
    </Popup_1.Popup>);
});
//# sourceMappingURL=TutorialMessages.js.map