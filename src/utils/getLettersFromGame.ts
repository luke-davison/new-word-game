...
export const getAbilityFromRawLetter = (rawLetter: RawLetter): Ability | undefined => {
  ...
  switch (ability) {
    case Abilities.InPosition1: return getInPositionAbility(abilityPoints, 1);
    case Abilities.InPosition2: return getInPositionAbility(abilityPoints, 2);
    case Abilities.InPosition3: return getInPositionAbility(abilityPoints, 3);
    case Abilities.InPosition4: return getInPositionAbility(abilityPoints, 4);
    ...
    case Abilities.OtherInPosition1: return getDoubleOtherLetterAbility(1);
    case Abilities.OtherInPosition2: return getDoubleOtherLetterAbility(2);
    case Abilities.OtherInPosition3: return getDoubleOtherLetterAbility(3);
    case Abilities.OtherInPosition4: return getDoubleOtherLetterAbility(4);
    case Abilities.OtherInPosition5: return getDoubleOtherLetterAbility(5);
    ...
    case Abilities.OtherInPosition5: return getPointsPerWildAbility(abilityPoints);
